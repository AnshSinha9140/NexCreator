...
const INITIAL_MESSAGES: InboxMessage[] = [
  ...
  },
  {
    ...
    snippet: "Recommended upload window: Publish Short #1 ('Streamer Somehow Won A 1v4') within 12 hours.",
    timestamp: "09:30 AM",
    group: "Today",
    isRead: false,
    priority: "high",
  ...
  },
  {
    ...
    snippet: "Auto-detected 4 viral moments including 1v4 clutch and chat emote explosion.",
    timestamp: "July 28",
    group: "Earlier",
    isRead: true,
    priority: "normal",
