    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
        ...
        <div style={{ padding: "16px", borderRadius: "14px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <ul style={{ margin: 0, paddingLeft: "16px", fontSize: "12px", color: "#cbd5e1", display: "flex", flexDirection: "column", gap: "6px", lineHeight: 1.5 }}>
        ...
        <div style={{ padding: "16px", borderRadius: "14px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ fontSize: "12px", fontWeight: "800", color: "#60a5fa", textTransform: "uppercase", marginBottom: "8px" }}>
      ...
      {changedMyMind.length > 0 && (
        <div style={{ padding: "16px", borderRadius: "14px", background: "rgba(168, 85, 247, 0.08)", border: "1px solid rgba(168, 85, 247, 0.25)", display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          {changedMyMind.map((item, idx) => (
            <div key={idx} style={{ fontSize: "12px", color: "#cbd5e1", display: "flex", flexDirection: "column", gap: "4px" }}>
              <div><span style={{ color: "#fb7185", textDecoration: "line-through" }}>Previous Belief: {item.previousBelief}</span></div>
              <div><strong style={{ color: "#34d399" }}>Updated Belief: {item.updatedBelief}</strong></div>
