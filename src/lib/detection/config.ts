export const DETECTION_CONFIG = {
  /**
   * Interval duration in milliseconds for background detection daemon poll loop (Default: 60 seconds / 1 minute)
   */
  POLL_INTERVAL_MS: Number(process.env.DETECTION_POLL_INTERVAL_MS) || 60000,
